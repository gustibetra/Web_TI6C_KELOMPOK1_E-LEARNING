...
--
-- Host: localhost:3306
-- Generation Time: Jun 30, 2026 at 05:01 AM
...
CREATE TABLE `absen` (
  ...
  `foto_pash` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('hadir','tidak_hadir','pending') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `absen` (`id_absen`, `id_mahasiswa`, `id_matkul`, `tanggal_absen`, `foto_pash`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2026-06-27 08:00:00', 'uploads/absen/citra_web.jpg', 'hadir', '2026-06-27 23:08:12', '2026-06-27 23:08:12'),
(2, 2, 2, '2026-06-27 10:00:00', 'uploads/absen/dedi_db.jpg', 'hadir', '2026-06-27 23:08:12', '2026-06-27 23:08:12'),
(3, 3, 1, '2026-06-27 08:00:00', 'uploads/absen/eka_web.jpg', 'tidak_hadir', '2026-06-27 23:08:12', '2026-06-27 23:08:12'),
(4, 4, 3, '2026-06-28 13:00:00', 'uploads/absen/fajar_jarkom.jpg', 'pending', '2026-06-27 23:08:12', '2026-06-27 23:08:12'),
(5, 5, 4, '2026-06-28 08:00:00', 'uploads/absen/gita_sisop.jpg', 'hadir', '2026-06-27 23:08:12', '2026-06-27 23:08:12'),
(6, 1, 1, '2026-06-29 09:57:55', 'uploads/absen/bo2LhII0BDdWWHTjZqn5hrpSfBhj52Jz19C3unry.jpg', 'hadir', '2026-06-29 09:57:55', '2026-06-29 09:58:33'),
(7, 1, 1, '2026-06-30 04:56:25', 'uploads/absen/tdCidbWEoHs97Tby7OVLCqfgwJVVb5KFOFAhcAGY.jpg', 'hadir', '2026-06-30 04:56:25', '2026-06-30 04:57:11');
...
CREATE TABLE `matakuliah` (
  ...
  `kode_matkul` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nama_matkul` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sks` int DEFAULT NULL,
  `semester` int DEFAULT NULL,
  `waktu_matkul` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `materi` (
  ...
  `deksripsi` text COLLATE utf8mb4_general_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `pengumpulan_tugas` (
  ...
  `id_mahasiswa` int NOT NULL,
  `link_pengumpulan_tugas` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pengumpulan_uas` (
  ...
  `id_uas` int NOT NULL,
  `id_mahasiswa` int NOT NULL,
  `link_pengumpulan_uas` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `kritik_dan_saran` text COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pengumpulan_uts` (
  ...
  `id_uts` int NOT NULL,
  `id_mahasiswa` int NOT NULL,
  `link_pengumpulan_uts` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tugas` (
  ...
  `soal_tugas` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `uas` (
  ...
  `id_matkul` int NOT NULL,
  `id_dosen` int NOT NULL,
  `deadline` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `soal_uas` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `uts` (
  ...
  `id_dosen` int NOT NULL,
  `deadline` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `soal_uts` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
