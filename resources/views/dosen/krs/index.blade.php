...
<h3><i class="fas fa-list-alt"></i> Kelola Mata Kuliah (Untuk KRS Mahasiswa)</h3>
<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah">
<i class="fas fa-plus"></i> Tambah Mata Kuliah
</button>
</div>
<div class="alert alert-info">
<i class="fas fa-info-circle"></i> <strong>Info:</strong> Mata kuliah yang Anda tambahkan di sini akan muncul di KRS mahasiswa untuk dipilih.
</div>
...
<form action="{{ route('dosen.krs.destroy', $item->id_matkul) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus mata kuliah ini?')">
@csrf @method('DELETE')
...
<form action="{{ route('dosen.krs.store') }}" method="POST">
@csrf
...
<input type="text" name="kode_matkul" class="form-control" placeholder="Contoh: KK21213362" required>
</div>
<div class="mb-3">
<label class="form-label">Nama MK</label>
<input type="text" name="nama_matkul" class="form-control" placeholder="Contoh: Object Oriented Programming 1" required>
</div>
<div class="row">
...
<input type="text" name="waktu_matkul" class="form-control" placeholder="Contoh: Senin 08:00-10:00" required>
</div>
</div>
...
<div class="modal-dialog">
<form action="{{ route('dosen.krs.update', $item->id_matkul) }}" method="POST">
@csrf @method('PUT')
<div class="modal-content">
