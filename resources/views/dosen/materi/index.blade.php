...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3><i class="fas fa-file-alt"></i> Daftar Materi</h3>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ Str::limit($item->deksripsi, 50) }}</td>
                        <td>
                        ...
                        <td>
                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalEdit{{ $item->id_materi }}">
                                <i class="fas fa-edit"></i> Edit
                            </button>
                            <form action="{{ route('dosen.materi.destroy', $item->id_materi) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus?')">
                                @csrf @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deksripsi" class="form-control" rows="3"></textarea>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="modalEdit{{ $item->id_materi }}" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('dosen.materi.update', $item->id_materi) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Deskripsi</label>
                        <textarea name="deksripsi" class="form-control" rows="3">{{ $item->deksripsi }}</textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <small class="text-muted">File saat ini: {{ $item->file_path }}</small>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
